...
Motor Trend has analysed automobile industry data and has identified data that supports/rejects the generally held belief that manual cars are provide more miles per gallon (mpg).  The analysis indicated that manual transmissions deliver ????? more mpg's than automatic.
...
Do some exploratory data anlysis

## Some appendix graphs?
